...
import { R as REDIRECT_STATUS_CODES, A as AstroError, i as ActionsReturnedInvalidDataError, D as DEFAULT_404_COMPONENT } from './astro/server_BtpAGawn.mjs';
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { PORT: "3005", _: process.env._ })?.DEV) {
...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__, { PORT: "3005", _: process.env._ })?.PROD) {
